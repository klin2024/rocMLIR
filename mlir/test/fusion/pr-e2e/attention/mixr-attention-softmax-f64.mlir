...
module {
  func.func private @mlir_attention(%arg0: !migraphx.shaped<1x12x256x256xf16, 786432x65536x256x1> {mhal.read_access}, %arg1: !migraphx.shaped<1x12x256x256xf16, 786432x65536x256x1> {mhal.read_access}, %arg2: !migraphx.shaped<12x256x256xsi8, 65536x256x1> {mhal.read_access}, %arg3: !migraphx.shaped<1x12x256x256xf16, 786432x65536x256x1> {mhal.read_access}, %arg4: !migraphx.shaped<12x256x256xf16, 65536x256x1> {mhal.read_access}) -> (!migraphx.shaped<12x256x256xf16, 65536x256x1> {mhal.write_access}) {
    ...
    %9 = migraphx.convert %8 {target_type = 3 : i64} : <12x256x256xf16, 65536x256x1> to <12x256x256xf64, 65536x256x1>
    %10 = migraphx.reshape %9 {dims = [12, 256, 256]} : <12x256x256xf64, 65536x256x1> -> <12x256x256xf64, 65536x256x1>
    %11 = migraphx.reduce_max %10 {axes = [2]} : <12x256x256xf64, 65536x256x1> -> <12x256x1xf64, 256x1x1>
    %12 = migraphx.reshape %11 {dims = [12, 256, 1]} : <12x256x1xf64, 256x1x1> -> <12x256x1xf64, 256x1x1>
    %13 = migraphx.multibroadcast %12 {out_dyn_dims = [], out_lens = [12, 256, 256]} : <12x256x1xf64, 256x1x1> -> <12x256x256xf64, 256x1x0>
    %14 = migraphx.sub %9, %13 : <12x256x256xf64, 65536x256x1>, <12x256x256xf64, 256x1x0> -> <12x256x256xf64, 65536x256x1>
    %15 = migraphx.exp %14 : <12x256x256xf64, 65536x256x1> -> <12x256x256xf64, 65536x256x1>
    %16 = migraphx.reshape %15 {dims = [12, 256, 256]} : <12x256x256xf64, 65536x256x1> -> <12x256x256xf64, 65536x256x1>
    %17 = migraphx.reduce_sum %16 {axes = [2]} : <12x256x256xf64, 65536x256x1> -> <12x256x1xf64, 256x1x1>
    %18 = migraphx.reshape %17 {dims = [12, 256, 1]} : <12x256x1xf64, 256x1x1> -> <12x256x1xf64, 256x1x1>
    %19 = migraphx.multibroadcast %18 {out_dyn_dims = [], out_lens = [12, 256, 256]} : <12x256x1xf64, 256x1x1> -> <12x256x256xf64, 256x1x0>
    %20 = migraphx.div %15, %19 : <12x256x256xf64, 65536x256x1>, <12x256x256xf64, 256x1x0> -> <12x256x256xf64, 65536x256x1>
    %21 = migraphx.convert %20 {target_type = 1 : i64} : <12x256x256xf64, 65536x256x1> to <12x256x256xf16, 65536x256x1>
